                    ...
                    <div class="form-section">
                        ...
                        <div class="row g-3">
                            <div class="col-md-6">
                                ...
                                <input type="text" name="name" class="form-control-dash" value="{{ old('name') }}"
                                    required>
                                @error('name')
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text" name="username" class="form-control-dash"
                                    value="{{ old('username') }}" placeholder="e.g. john-doe">
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="email" name="email" class="form-control-dash" value="{{ old('email') }}"
                                    required>
                                @error('email')
                                    <small class="text-danger">{{ $message }}</small>
                                @enderror
                            ...
                            <div class="col-md-6">
                                <label class="form-label-dash">Password *</label>
                                <input type="password" name="password" class="form-control-dash" required>
                                @error('password')
                                    <small class="text-danger">{{ $message }}</small>
                                @enderror
                            </div>
                            <div class="col-md-6">
                                <label class="form-label-dash">Confirm Password *</label>
                                <input type="password" name="password_confirmation" class="form-control-dash" required>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="form-section">
                        ...
                        <div class="row g-3">
                            <div class="col-md-6">
                                ...
                                <input type="text" name="title" class="form-control-dash" value="{{ old('title') }}"
                                    placeholder="e.g. Full Stack Developer">
                            </div>
                            <div class="col-md-6">
                                <label class="form-label-dash">Phone Number</label>
                                <input type="text" name="phone" class="form-control-dash" value="{{ old('phone') }}"
                                    placeholder="+966 5X XXX XXXX">
                            </div>
                            <div class="col-md-12">
                                <label class="form-label-dash">Location</label>
                                <input type="text" name="location" class="form-control-dash"
                                    value="{{ old('location') }}" placeholder="e.g. Al-Hofuf, Saudi Arabia">
                            </div>
                            <div class="col-12">
                                <label class="form-label-dash">Bio / About</label>
                                <textarea name="bio" class="form-control-dash" rows="4" placeholder="Tell about this user...">{{ old('bio') }}</textarea>
                            </div>
                            <div class="col-12">

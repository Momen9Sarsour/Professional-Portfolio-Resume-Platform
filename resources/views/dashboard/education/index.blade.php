...
@section('content')
    ...
    <div class="d-flex align-items-center justify-content-between mb-4 fade-up">
        <h5 style="font-size:18px;font-weight:700;color:#1a2035;margin:0;">
            Education <small style="font-size:13px;font-weight:400;color:#7a869a;margin-left:8px;">{{ $education->total() }}
                total</small>
        </h5>
    ...
    <div class="filter-bar fade-up d1">
        <input type="text" id="searchInput" class="search-input" placeholder="Search university or degree..."
                ...
                <tbody>
                    @forelse($education as $edu)
                        <tr>
                            ...
                            <td>
                                <form action="{{ route('dashboard.education.toggle', $edu->id) }}" method="POST"
                            ...
                            <td>
                                <div style="display:flex;gap:6px;align-items:center;">
                                    <button class="action-btn action-view"
                                        onclick="openShow({{ $edu->id }}, '{{ addslashes($edu->degree) }}', '{{ addslashes($edu->university) }}', '{{ $edu->start_date }}', '{{ $edu->end_date }}', '{{ addslashes($edu->description) }}', {{ $edu->sort_order }})">
                                        <i class="bi bi-eye-fill"></i>
                                    </button>
                                    <button class="action-btn action-edit"
                                        onclick="openEdit({{ $edu->id }}, '{{ addslashes($edu->degree) }}', '{{ addslashes($edu->university) }}', '{{ $edu->start_date }}', '{{ $edu->end_date }}', '{{ addslashes($edu->description) }}', {{ $edu->sort_order }})">
                                        <i class="bi bi-pencil-fill"></i>
                                    </button>
                                    <button class="action-btn action-del"
                                        onclick="openDeleteModal({{ $edu->id }}, '{{ addslashes($edu->degree) }}')">
        ...
        @if ($education->hasPages())
            <div
                ...
                <div style="font-size:13px;color:#7a869a;">
                    Showing {{ $education->firstItem() }}–{{ $education->lastItem() }} of {{ $education->total() }}
                    education records
                </div>
                    ...
                    <div class="modal-body">
                        ...
                        <div class="row g-3">
                            <div class="col-md-6">
                                ...
                                <input type="text" name="degree" class="form-control-dash"
                                    placeholder="e.g. Bachelor of Computer Science" required>
                            </div>
                            <div class="col-md-6">
                                <label class="form-label-dash">University *</label>
                                <input type="text" name="university" class="form-control-dash"
                                    placeholder="e.g. Arab Open University" required>
                            </div>
                            <div class="col-md-6">
    ...
    <div class="modal fade modal-dash" id="editModal" tabindex="-1">
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" style="font-weight:700;"><i class="bi bi-pencil-fill me-2"></i>Edit Education
                    </h5>
                    <button type="button" class="btn-close" data-bs-dismiss="modal"></button>
                </div>
                <form id="editForm" method="POST">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="row g-3">
                            <div class="col-md-6">
                                <label class="form-label-dash">Degree *</label>
                                <input type="text" name="degree" id="edit_degree" class="form-control-dash"
                                    required>
                            </div>
                            <div class="col-md-6">
                                <label class="form-label-dash">University *</label>
                                <input type="text" name="university" id="edit_university" class="form-control-dash"
                                    required>
                            </div>
                            <div class="col-md-6">
                                <label class="form-label-dash">Start Date *</label>
    ...
    <div class="modal fade modal-dash" id="showModal" tabindex="-1">
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" style="font-weight:700;"><i class="bi bi-eye-fill me-2"></i>Education Details
                    </h5>
                    <button type="button" class="btn-close" data-bs-dismiss="modal"></button>
                </div>
                <div class="modal-body">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <p style="font-size:14px;color:#1a2035;">Are you sure you want to delete <strong
                            id="delete_education_name"></strong>?</p>

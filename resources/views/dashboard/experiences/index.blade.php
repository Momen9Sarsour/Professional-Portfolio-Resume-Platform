...
@section('content')
    ...
    <div class="d-flex align-items-center justify-content-between mb-4 fade-up">
        <h5 style="font-size:18px;font-weight:700;color:#1a2035;margin:0;">
            Experiences <small
                style="font-size:13px;font-weight:400;color:#7a869a;margin-left:8px;">{{ $experiences->total() }}
                total</small>
        </h5>
    ...
    <div class="filter-bar fade-up d1">
        <input type="text" id="searchInput" class="search-input" placeholder="Search company or job title..."
                ...
                <tbody>
                    @forelse($experiences as $exp)
                        <tr>
                            ...
                            <td>
                                <form action="{{ route('dashboard.experiences.toggle', $exp->id) }}" method="POST"
                            ...
                            <td>
                                <div style="display:flex;gap:6px;align-items:center;">
                                    <button class="action-btn action-view"
                                        onclick="openShow({{ $exp->id }}, '{{ addslashes($exp->job_title) }}', '{{ addslashes($exp->company) }}', '{{ $exp->start_date }}', '{{ $exp->end_date }}', '{{ addslashes($exp->description) }}', {{ $exp->sort_order }})">
                                        <i class="bi bi-eye-fill"></i>
                                    </button>
                                    <button class="action-btn action-edit"
                                        onclick="openEdit({{ $exp->id }}, '{{ addslashes($exp->job_title) }}', '{{ addslashes($exp->company) }}', '{{ $exp->start_date }}', '{{ $exp->end_date }}', '{{ addslashes($exp->description) }}', {{ $exp->sort_order }})">
                                        <i class="bi bi-pencil-fill"></i>
                                    </button>
                                    <button class="action-btn action-del"
                                        onclick="openDeleteModal({{ $exp->id }}, '{{ addslashes($exp->job_title) }}')">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="row g-3">
                            <div class="col-md-6">
                                ...
                                <input type="text" name="job_title" class="form-control-dash"
                                    placeholder="e.g. Full Stack Developer" required>
                            </div>
                            <div class="col-md-6">
                                <label class="form-label-dash">Company *</label>
                                <input type="text" name="company" class="form-control-dash"
                            ...
                            <div class="col-12">
                                ...
                                <textarea name="description" class="form-control-dash" rows="4"
                                    placeholder="Describe your responsibilities, achievements, technologies used..."></textarea>
                            </div>
                            <div class="col-md-6">
                            ...
                            <div class="col-md-6">
                                <label
                                    style="display:flex;align-items:center;gap:8px;cursor:pointer;font-size:13.5px;font-weight:600;margin-top:32px;">
    ...
    <div class="modal fade modal-dash" id="editModal" tabindex="-1">
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" style="font-weight:700;"><i class="bi bi-pencil-fill me-2"></i>Edit
                        Experience</h5>
                    <button type="button" class="btn-close" data-bs-dismiss="modal"></button>
                </div>
                <form id="editForm" method="POST">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="row g-3">
                            <div class="col-md-6">
                                <label class="form-label-dash">Job Title *</label>
                                <input type="text" name="job_title" id="edit_job_title" class="form-control-dash"
                                    required>
                            </div>
                            <div class="col-md-6">
                                <label class="form-label-dash">Company *</label>
                                <input type="text" name="company" id="edit_company" class="form-control-dash"
                                    required>
                            </div>
                            <div class="col-md-6">
                                <label class="form-label-dash">Start Date *</label>
                                <input type="date" name="start_date" id="edit_start_date" class="form-control-dash"
                                    required>
                            </div>
                            <div class="col-md-6">
                                <label class="form-label-dash">End Date</label>
    ...
    <div class="modal fade modal-dash" id="showModal" tabindex="-1">
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" style="font-weight:700;"><i class="bi bi-eye-fill me-2"></i>Experience
                        Details</h5>
                    <button type="button" class="btn-close" data-bs-dismiss="modal"></button>
                </div>
                <div class="modal-body">
    ...
    <div class="modal fade modal-dash" id="deleteModal" tabindex="-1">
        <div class="modal-dialog modal-sm">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" style="font-weight:700;"><i class="bi bi-trash-fill me-2"></i>Delete
                        Experience</h5>
                    <button type="button" class="btn-close" data-bs-dismiss="modal"></button>
                </div>
                <div class="modal-body">
                    <p style="font-size:14px;color:#1a2035;">Are you sure you want to delete <strong
                            id="delete_experience_name"></strong>?</p>
...
@push('scripts')
    <script>
        ...
        function openShow(id, jobTitle, company, startDate, endDate, description, sortOrder) {
            ...
            let end = endDate ? new Date(endDate).toLocaleDateString('en-US', {
                year: 'numeric',
                month: 'long'
            }) : 'Present';

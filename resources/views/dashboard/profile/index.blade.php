    ...
    <div class="row g-4">
        ...
        <div class="col-lg-4 fade-up d1">
            <div class="card-box text-center">
                    ...
                    @php
                        $avatarUrl =
                            $profile && $profile->avatar
                                ...
                                : 'https://ui-avatars.com/api/?background=2f7bff&color=fff&size=120&name=' .
                                    urlencode($user->name);
                    @endphp
                ...
                <p style="color: #7a869a; font-size: 13px; margin-bottom: 16px;">{{ $profile->title ?? 'Add your title' }}
                </p>
                    ...
                    <div class="mt-3 pt-2">
                        ...
                        <p style="font-weight: 600; color: #2f7bff; margin: 0;">
                            ...
                            <a href="{{ route('cv.show', $user->username) }}" target="_blank"
                                style="color: #2f7bff; text-decoration: none;">
                    ...
                    <div class="row g-3">
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="text" name="username" class="form-control-dash"
                                value="{{ old('username', $user->username) }}" placeholder="e.g. momen-sarsour">
                        ...
                        <div class="col-md-12">
                            ...
                            <input type="text" name="title" class="form-control-dash"
                                value="{{ old('title', $profile->title ?? '') }}" placeholder="e.g. Full Stack Developer">
                            @error('title')
                                <small class="text-danger">{{ $message }}</small>
                            @enderror
                        </div>
                        ...
                        <div class="col-12">
                            ...
                            <textarea name="bio" class="form-control-dash" rows="4"
                        ...
                        <div class="col-12">
                            ...
                            <input type="file" name="avatar" id="avatarFileInput" class="form-control-dash"
                                accept="image/*">
                ...
                <form method="POST" action="{{ route('dashboard.profile.password') }}">
                    ...
                    <div class="row g-3">
                        <div class="col-md-12">
                            ...
                            <input type="password" name="current_password" class="form-control-dash"
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="password" name="new_password" class="form-control-dash"
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="password" name="new_password_confirmation" class="form-control-dash"
                    ...
                    <div class="col-12">
                        <div class="d-flex justify-content-between align-items-center flex-wrap gap-3">
                            <div>
                                ...
                                <small style="color: #7a869a;">Once you delete your account, there is no going back. All
                                    your data will be permanently removed.</small>
                            </div>
        ...
        <div class="modal-dialog modal-sm">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" style="font-weight:700;"><i class="bi bi-exclamation-triangle-fill me-2"
                            style="color: #ef4444;"></i>Delete Account</h5>
                ...
                <form action="{{ route('dashboard.profile.destroy') }}" method="POST">
                    ...
                    <div class="modal-body">
                        ...
                        <p style="font-size:13px;color:#7a869a;margin-bottom:16px;">This action cannot be undone. All your
                            data will be permanently removed.</p>
                        <div class="mb-3">
                            <label class="form-label-dash">Enter your password to confirm</label>
                            <input type="password" name="password" class="form-control-dash" placeholder="••••••••"
                                required>
                            @error('password')
                                <small class="text-danger">{{ $message }}</small>
                            @enderror

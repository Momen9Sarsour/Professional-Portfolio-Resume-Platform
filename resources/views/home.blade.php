...
<head>
    ...
    <meta name="description"
        content="Mo'men Sarsour - Full Stack Developer | Computer Systems Engineer | Professional CV Builder">
...
<body>
        ...
        <div class="container hero-content">
            <div class="row align-items-center g-5">
                ...
                <div class="col-lg-5 text-center animate delay-3">
                    <div
                        style="background: rgba(255,255,255,0.8); backdrop-filter: blur(20px); border-radius: 24px; padding: 32px; border: 1px solid rgba(255,255,255,0.3); box-shadow: 0 20px 50px rgba(0,0,0,0.08);">
                        <div style="font-size: 14px; color: #7a869a; font-weight: 600; margin-bottom: 16px;">📄 Sample
                            CV Preview</div>
                        <div
                            style="background: var(--gradient-2); border-radius: 16px; padding: 20px; color: white; text-align: left;">
                            <div style="display: flex; align-items: center; gap: 12px;">
                                <div
                                    style="width: 40px; height: 40px; border-radius: 50%; background: rgba(255,255,255,0.2); display: flex; align-items: center; justify-content: center; font-weight: 700;">
                                    MS</div>
                                <div>
                            ...
                            <div style="margin-top: 12px;">
                                <div
                                    style="height: 4px; background: rgba(255,255,255,0.2); border-radius: 2px; margin-bottom: 6px; width: 80%;">
                                </div>
                                <div
                                    style="height: 4px; background: rgba(255,255,255,0.15); border-radius: 2px; margin-bottom: 6px; width: 60%;">
                                </div>
                                <div style="display: flex; gap: 6px; flex-wrap: wrap; margin-top: 8px;">
                                    <span
                                        style="background: rgba(255,255,255,0.15); padding: 2px 10px; border-radius: 20px; font-size: 9px;">Laravel</span>
                                    <span
                                        style="background: rgba(255,255,255,0.15); padding: 2px 10px; border-radius: 20px; font-size: 9px;">PHP</span>
                                    <span
                                        style="background: rgba(255,255,255,0.15); padding: 2px 10px; border-radius: 20px; font-size: 9px;">MySQL</span>
                                </div>
                            </div>
                        </div>
                        <div style="font-size: 11px; color: #94a3b8; margin-top: 12px;">
                            <i class="bi bi-check-circle-fill" style="color: #22c55e;"></i> Professional design •
                            Multiple formats
                        </div>
                    </div>
                </div>
                ...
                <div class="col-lg-4 col-md-6 animate delay-2">
                    <div class="template-showcase-card">
                        ...
                        <div class="body">
                            ...
                            <a href="{{ route('cv.show', $user->username ?? '') }}" target="_blank"
                                class="btn-preview">
                ...
                <div class="col-lg-4 col-md-6 animate delay-3">
                    <div class="template-showcase-card">
                        ...
                        <div class="body">
                            ...
                            <a href="{{ route('cv.show', $user->username ?? '') }}?template=minimal" target="_blank"
                                class="btn-preview">
                                <i class="bi bi-eye-fill"></i> Preview
                            </a>
                        </div>
                ...
                <div class="col-lg-4 col-md-6 animate delay-4">
                    <div class="template-showcase-card">
                        ...
                        <div class="body">
                            ...
                            <a href="{{ route('cv.show', $user->username ?? '') }}?template=creative" target="_blank"
                                class="btn-preview">
                                <i class="bi bi-eye-fill"></i> Preview
                            </a>
                        </div>
                ...
                <div class="col-lg-4 col-md-6 animate delay-2">
                    <div class="template-showcase-card">
                        ...
                        <div class="body">
                            ...
                            <a href="{{ route('cv.show', $user->username ?? '') }}?template=professional"
                ...
                <div class="col-lg-4 col-md-6 animate delay-3">
                    <div class="template-showcase-card">
                        ...
                        <div class="body">
                            ...
                            <a href="{{ route('cv.show', $user->username ?? '') }}?template=sidebar" target="_blank"
                                class="btn-preview">
                                <i class="bi bi-eye-fill"></i> Preview
                            </a>
                        </div>
                ...
                <div class="col-lg-4 col-md-6 animate delay-4">
                    <div class="template-showcase-card">
                        ...
                        <div class="body">
                            ...
                            <a href="{{ route('cv.show', $user->username ?? '') }}?template=classic" target="_blank"
                                class="btn-preview">
                                <i class="bi bi-eye-fill"></i> Preview
                            </a>
                        </div>
    ...
    <section style="background: var(--gradient-2); padding: 60px 0; color: white;">
        <div class="container text-center">
            <h2 style="font-size: 36px; font-weight: 800;">Ready to build your <span
                    style="color: #63b3ed;">professional CV</span>?</h2>
            <p style="opacity: 0.8; font-size: 17px; max-width: 500px; margin: 12px auto 32px;">Join thousands of
                professionals who use our platform</p>
            @guest
                <a href="{{ route('register') }}" class="btn-hero-primary"
                    style="background: white; color: #0f172a; box-shadow: 0 10px 30px rgba(0,0,0,0.2);">
                    <i class="bi bi-person-plus"></i> Get Started Free
                </a>
                <a href="{{ route('login') }}"
                    style="color: white; opacity: 0.7; text-decoration: none; margin-left: 20px; font-weight: 600;">
    ...
    <footer class="footer">
        <div class="container">
            <div class="row align-items-center">
                <div class="col-md-4">
                    <div class="brand"
                        style="color: white; font-size: 20px; font-weight: 800; display: flex; align-items: center; gap: 8px; text-decoration: none;">
                        <span class="logo-dot"
                            style="width:10px;height:10px;border-radius:50%;background:var(--gradient-1);display:inline-block;"></span>
                        <span>Mo'men</span>
                    </div>
